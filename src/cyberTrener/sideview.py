    ...
    try:
        ...
        while video.isOpened():
            ...
            if result.pose_landmarks:
                ...
                elif elbow_angle > TOP_THRESHOLD and stage == "down":
                    rep_count += 1
                    stage = "up"
                ...
                leg_correct = leg_angle > LEG_MIN_ANGLE
                body_correct = BODY_MIN_ANGLE <= body_angle <= BODY_MAX_ANGLE
                ...
                # Torso warning
                if not body_correct and stage == "down":
                    cv.putText(
                        frame,
        ...
        # Gwarantuje czyszczenie zasobów nawet w przypadku crashu kodu
        video.release()
